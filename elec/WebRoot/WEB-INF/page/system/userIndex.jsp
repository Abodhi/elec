...
<HTML>
	...
	<body >
			...
			<table cellspacing="1" cellpadding="0" width="90%" align="center" bgcolor="#f5fafe" border="0">
				...
				<tr>
					...
					<td class="ta_01" colspan="3">
						...
						<s:textfield name="onDutyDateBegin" id="onDutyDateBegin" value="%{begin}" maxlength="50" size="20" onclick="WdatePicker()"></s:textfield>
						~
						<s:date name="onDutyDateEnd" format="yyyy-MM-dd" var="end"/>
						<s:textfield name="onDutyDateEnd" id="onDutyDateEnd" value="%{end}" maxlength="50" size="20" onclick="WdatePicker()"></s:textfield>
					</td>
				</tr>
		...
		<form id="Form2" name="Form2" action="${pageContext.request.contextPath }/system/elecUserAction_home.do" method="post">
		<table cellSpacing="1" cellPadding="0" width="90%" align="center" bgColor="#f5fafe" border="0">
			<TBODY>
				<TR height=10><td></td></TR>			
				<tr>
								...
								<s:iterator value="#request.userList" var="user">
									<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
										<td style="HEIGHT:22px" align="center" width="5%">
											<input type="checkbox" name="userID" id="userID" value='<s:property value="#user.userID"/>'>
										</td>
										...
										<td style="HEIGHT:22px" align="center" width="15%">
											<s:property value="#user.onDutyDate"/>
										</td>								
										<td style="HEIGHT:22px" align="center" width="8%">
											<s:property value="#user.postID"/>
										</td>
										
										<td align="center" style="HEIGHT: 22px" align="center" width="10%">																	
										   <a href="#" onclick="openWindow('${pageContext.request.contextPath }/system/elecUserAction_edit.do?userID=<s:property value="#user.userID"/>','700','400');">
