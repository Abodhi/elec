...
<html>
 ...
 <body>
    ...
    <table cellSpacing="1" cellPadding="5" width="680" align="center" bgColor="#eeeeee" style="border:1px solid #8ba7e3" border="0">
     ...
     <tr>
         ...
         <td class="ta_01" bgColor="#ffffff">
         	<s:textfield name="logonName" id="logonName" maxlength="25" size="20" readonly="true"></s:textfield>
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			<s:password name="passwordconfirm" id="passwordconfirm" maxlength="25"  size="22" value="%{logonPwd}" showPassword="true"></s:password>
		</td>
	</tr>
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			<s:date name="birthday" format="yyyy-MM-dd" var="date1"/>
			<s:textfield name="birthday" id="birthday" maxlength="50" value="%{date1}"  size="20" onClick="WdatePicker()"></s:textfield>
		</td>
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			<s:date name="onDutyDate" format="yyyy-MM-dd" var="date2"/>
			<s:textfield name="onDutyDate" id="onDutyDate" maxlength="50" size="20" value="%{date2}" onClick="WdatePicker()"></s:textfield>
			<font color="#FF0000">*</font>
		</td>
		<td align="center" bgColor="#f5fafe" class="ta_01">离职日期：</td>
		<td class="ta_01" bgColor="#ffffff">
			<s:date name="offDutyDate" format="yyyy-MM-dd" var="date3"/>
			<s:textfield name="offDutyDate" id="offDutyDate" maxlength="50" size="20" value="%{date3}" onClick="WdatePicker()" onblur="checkIsDuty(this)"></s:textfield>
		</td>
	</tr>
	<TR>
